/* 
   * Desc:
   * This program uses Map151.java to store key value pairs of words of a text ,
...
public class WordCounts1 {
    String url;
    Map151 <String,Integer> storage = new Map151<>();
    //num of words
    int wNum = 0;
    //unique num
    int uNum = 0;
    ...
    public void reader1(String url) {
    ...
    public static void main(String[] args) {
        ...
        WordCounts1 allWords = new WordCounts1();
        allWords.reader1(args[0]);
        ...
        WordCounts1 a = new WordCounts1();
        a.reader1("hamoneword.txt");
        System.out.println(a.max + " " + a.uNum + " " + a.wNum + " " + a.mWord);
         */
    }
}