...
public class PlaceContainer {
  ...
  List151Impl<Place> allZips;
    ...
    public PlaceContainer(String url) {
        ...
        //no data to search.
            csvReader = null;
            allZips = new List151Impl<Place>(0);
            return;
        }

        allZips = new List151Impl<Place>(50000);
        ...
        while (iitt.hasNext()) {
            ...
            //a bunch of test
            //System.out.println("\n");
            //System.out.print(allZips.get(i))
            //for testing
    ...
    /*public static void main(String[]args){
        PlaceContainer c = new PlaceContainer("shuffzip.csv");
        //LocatedPlace a= new LocatedPlace("1234","Syracuse","NY","55","33","1","2");
        //System.out.println(b); 

        Place a=c.lookupZip("71166");
        System.out.print(a);

       /* Place a= new Place ("71166"," "," ");
        Place b= allZips.getInstance(a);
        System.out.println(b);
    }*/
}