/* 
   * Desc:
   * This program uses ProbeHTInc.java to store key value pairs of words of a text ,
...
public class WordCounts2 {
    String url;
    ProbeHTInc <String,Integer> storage = new ProbeHTInc<>();
    //num of words
    int wNum = 0;
    //unique num
    int uNum = 0;
    ...
    public void reader2(String url) {
    ...
    public static void main(String[] args) {
        ...
        WordCounts2 allWords = new WordCounts2();
        allWords.reader2(args[0]);
